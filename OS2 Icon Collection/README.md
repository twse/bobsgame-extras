These textual icons are for use with OS/2 applications.
...
This icon collection is subject to the following OS/2 software collections and sites which are located at:
