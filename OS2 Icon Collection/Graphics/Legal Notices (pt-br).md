...
3. Auto Adjust Photo
   ...
   - – Site de download: http://log69.com/aaphoto_en.html (link em inglês) ou http://log69.com/aaphoto.html (link em húngaro)
4. AutoTrace
   - – Licença: GPL 2.0
...
8. Belvoir, JPEGDUMP
   ...
   - – Site de download: http://home.uni-one.nl/m1 (link em inglês)
...
30. FreeType
    - – Licença: Libre
    - – Aviso de copyright: Copyright (c) 1994-2019 O Projeto FreeType
...
32. GIFLIB
    ...
    - – Site de download: http://giflib.sourceforge.net/ (link em inglês)
33. GIFtrans
    - – Licença: GPL 2.0
    - – Aviso de copyright: Copyright (c) 1994 Andreas Ley
34. GIMP
    - – Licença: GPL 3.0 (programa), LGPL 3.0 (biblioteca), CC-SA 4.0 (site Web)
    - – Aviso de copyright: Copyright (c) 1995-2020 Spencer Kimball, Peter Mattis e o equipo de desenvolvimento de GIMP
    - – Site de download: https://www.gimp.org/ (link em inglês)
35. GramoFile
    - – Licença: GPL 2.0
    - – Aviso de copyright: Copyright (c) 1998-2001 Jeroen A. Bezemer
...
46. JasPer
    - – Licença: Libre
    - – Aviso de copyright: Copyright (c) 2001-2019 Michael David Adams
    - – Site de download: https://www.ece.uvic.ca/~frodo/jasper/ (link em inglês)
47. Jhead
    - – Licença: Dominio público
...
48. jp2a
    - – Licença: GPL 2.0
    - – Aviso de copyright: Copyright (c) 2006 Christian Stigen Larsen
...
51. LibGD
    ...
    - – Site de download: https://libgd.github.io/
52. libjpeg
    - – Licença: Libre
    - – Aviso de copyright: Copyright (c) 1991-2018 Thomas G. Lane, Guido Vollbeding
...
59. OptiPNG
    ...
    - – Site de download: http://optipng.sourceforge.net/ (link em inglês)
60. Painter, TPaint
    - – Licença: GPL 2.0
61. Panorama Tools
    - – Licença: GPL 2.0
    - – Aviso de copyright: Copyright (c) 1998-2006 Helmut Dersch
    - – Site de download: http://panotools.sourceforge.net/ (link em inglês)
62. PhotoQt
    - – Licença: GPL 2.0
...
68. PMJPEG
    ...
    - – Site de download: http://www.pixvision.com/ (link em inglês)
69. PmPaint
    - – Licença: Libre
...
74. Potrace
    ...
    - – Site de download: http://potrace.sourceforge.net/ (link em inglês)
75. PPM2FLI
    - – Licença: Libre
    - – Aviso de copyright: Copyright (c) 1993-1999 Klaus Ehrenfried
76. PTPro
    - – Licença: GPL 2.0
    - – Aviso de copyright: Copyright (c) 2006-2015 Richard L. Walsh
77. QIViewer
    - – Licença: GPL 2.0
...
79. QVV
    - – Licença: Libre
    - – Aviso de copyright: Copyright (c) 1999-2017 Vladi Belperchinov-Shabanski
    - – Site de download: http://cade.datamax.bg/qvv (link em inglês)
80. RTMMM
    - – Licença: Libre
...
84. SANE
    - – Licença: GPL 2.0
    - – Aviso de copyright: Copyright (c) 1998-2017 David Mosberger-Tang e os desenvolvedores SANE
